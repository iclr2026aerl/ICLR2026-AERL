...
def load_data():
    data = np.load('dataset/cifar100_data.npz')
...
def load_model_and_data(args):
    ...
    if args.model == 'resnet':
        from models.resnet import Resnet18forCifar100
        ...
        raise ValueError('Resnet50forCifar100 is not implemented. Please use "resnet" instead.')
    elif args.model == 'cnn':
        from models.cnn import CNNModelforCifar100
        ...
        from models.densenet import Densenet121forCifar100
        from data.transform import train_transform_224, val_test_transform_224
